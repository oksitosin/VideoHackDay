...
CanvasVideoPlayer.prototype.loop = function() {
	...
	if((time - this.lastTimeClarified) / 1000 > 5){
		this.lastTimeClarified = time;

		var u8a = this.ctx.getImageData(0, 0, this.width, this.height).data;
		var a = this.canvas.toDataURL('image/jpeg').substring(23);

		var objs = {base64: a};
		// console.log(objs);
		explode(Clarifai.GENERAL_MODEL, objs);
	}
