      ...
      for(var index in concepts){
        ...
        if( word === translated || translated.trim() === "") {
          ...
          for(var idx in arr){
            ...
            translated = translated.replace(arr[idx], '');
          }
          var now = Date.now();
          var id = "emoji-" + word.replace(' ', '-') + "-" + idx + "-" + now;
          string = "<div class='a' id='" + id + "'>" + translated + "</div>";
          // console.log(string);
          document.getElementById("demo").innerHTML = document.getElementById("demo").innerHTML + string;
          animateDiv("#" + id);
        }
      }
...
},{"emojilib":4}],3:[function(require,module,exports){
module.exports={
  "grinning": {
